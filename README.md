...
Для того чтобы воспользоваться плеером, вам необходимо скачать репозиторий на свой компьютер.
...
Вы попадете на страницу с плеером:
...
Для использования локального сервера и изменения `index.html` без повторного открытия 
